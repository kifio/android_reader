...
package me.kifio.kreader.android.epub
...
import me.kifio.kreader.android.databinding.PopupWindowUserSettingsBinding
import me.kifio.kreader.android.utils.extensions.color
import java.io.File
...
class UserSettings(var preferences: SharedPreferences, val context: Context, private val UIPreset: MutableMap<ReadiumCSSName, Boolean>) {
    ...
    fun userSettingsPopUp(): PopupWindow {
        ...
        spec.setContent(me.kifio.kreader.android.R.id.SettingsTab)
        spec.setIndicator("Settings")
        host.addTab(spec)

        //Tab 2
        spec = host.newTabSpec("Advanced")
        spec.setContent(me.kifio.kreader.android.R.id.Advanced)
        ...
        val fonts = context.resources.getStringArray(me.kifio.kreader.android.R.array.font_list)
